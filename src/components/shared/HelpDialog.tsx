          ...
          <TabsContent value="about">
            <div style={scrollPanelStyle}>
              ...
              <div style={sectionStyle}>
                ...
                <p style={sectionContentStyle}><a href="https://dorms.school/links" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>{helpContent.about.credit}</a></p>
              </div>
              <div style={sectionStyle}>
